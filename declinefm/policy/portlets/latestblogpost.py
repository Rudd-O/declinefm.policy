...
from declinefm.policy import policyMessageFactory as _
...
class ILatestBlogPost(IPortletDataProvider):
    """A portlet
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(ILatestBlogPost)
